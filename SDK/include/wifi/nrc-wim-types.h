...
enum wim_system_cap {
	WIM_SYSTEM_CAP_USF = (1 << 0),
	WIM_SYSTEM_CAP_HWSEC = (1 << 1),
	WIM_SYSTEM_CAP_HWSEC_OFFL = (1 << 2),
	WIM_SYSTEM_CAP_CHANNEL_2G = (1 << 3),
	WIM_SYSTEM_CAP_CHANNEL_5G = (1 << 4),
	WIM_SYSTEM_CAP_MULTI_VIF = (1 << 5)
};
