...
firmware: $(OUT_PATH) $(OBJ_PATH) $(OBJS) $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) $(SECURE_LIBS) $(EZIOT_LIBS) $(EZIOT_LINKLIBS) 
#	@echo "Link Script : $(LD_FILE)"
	@echo "Linking $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT).elf"
	@$(CC) $(LFLAGS) -Wl,--whole-archive $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) $(SECURE_LIBS) $(TUYA_SDK_LIBS) $(EZIOT_LIBS) $(EZIOT_LINKLIBS)  -Wl,--no-whole-archive $(OBJS) -lc -o $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT).elf
...
firmware: $(OUT_PATH) $(OBJ_PATH) $(OBJS) $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) $(SECURE_LIBS) $(TUYA_SDK_LIBS) $(EZIOT_LIBS) $(EZIOT_LINKLIBS) 
	@echo "Linking OTA $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT)_1.elf"
	@$(CC) $(LFLAGS) -T$(LD_FILE)  -Wl,--whole-archive $(WIFI_LIBS) $(PSM_LIBS) $(WIFILMAC_LIBS) $(ALIYUN_SDK_LIBS) $(SECURE_LIBS) $(TUYA_SDK_LIBS) $(EZIOT_LIBS) $(EZIOT_LINKLIBS)  -Wl,--no-whole-archive $(OBJS) -lc -o $(OUT_PATH)/$(type)/$(TARGET)/$(OUTPUT)_1.elf
