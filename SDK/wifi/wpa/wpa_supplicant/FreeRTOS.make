...
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/crypto_mbedtls-bignum.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/crypto_mbedtls-ec.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/sha256-wpa.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/sha256-prf.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/sha256-internal.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/ccmp.c
WPA_SUPP_CSRCS += $(WPA_SUPP_ROOT)/src/crypto/aes-ccm.c
NEED_ECC=y
NEED_DH_GROUPS=y
endif
